...
function bdis_show_options()
{
	...
	usrOpt = document.createElement("pre");
	usrOpt.innerHTML = "          L - Free Format Label";
	$("#bdis").append(usrOpt);
...
function init_bdis_opt1()
{
	...
	usrOpt = document.createElement("pre");
	usrOpt.innerHTML = "\n Dispensing type [<input id=\"bdis_opt1_dispensingtype\" maxlength=\"10\">]         Ward [<input id=\"bdis_opt1_ward\" maxlength=\"5\">] <span id=\"bdis_opt1_wardname\"></span>";
	$("#bdis").append(usrOpt);
	
	usrOpt = document.createElement("pre");
	usrOpt.innerHTML = " Patient [<input id=\"bdis_opt1_patient\" maxlength=\"25\">]  Presc [<input id=\"bdis_opt1_prescriber\" maxlength=\"4\">] <span id=\"bdis_opt1_prescribername\"></span>";
	$("#bdis").append(usrOpt);
	
	usrOpt = document.createElement("pre");
	usrOpt.innerHTML = " Drug [<input id=\"bdis_opt1_drug\" maxlength=\"27\">]  Specialty : <span id=\"bdis_opt1_specialty\"></span>";
	$("#bdis").append(usrOpt);
	...
	usrOpt = document.createElement("pre");
	usrOpt.innerHTML = " Issue [<input id=\"bdis_opt1_issue\" maxlength=\"6\">] <span id=\"bdis_opt1_issueinfo\"></span>\n\n";
	$("#bdis").append(usrOpt);
